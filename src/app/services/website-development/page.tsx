...
import { Globe, Check, Calculator, Star, Users, Clock, Shield, Zap, HeartHandshake } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-blue-600/30 backdrop-blur-sm rounded-3xl p-10 border border-blue-500/20 shadow-2xl">
              <div className="text-center mb-10">
                <div className="text-9xl font-bold text-white mb-4 leading-none">50</div>
                <div className="text-2xl text-blue-100 mb-6">دينار شهرياً</div>
                <div className="text-blue-200 text-xl mb-10 leading-relaxed">يشمل الاستضافة والاستشارة والتصميم</div>
              </div>
              ...
              <div className="relative">
                <Button
                  ...
                  className="w-full bg-white/90 hover:bg-white text-blue-700 text-lg py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
                >
            ...
            <div className="text-center lg:text-right">
              ...
              <p className="text-2xl text-blue-100 leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
                تصميم وتطوير مواقع احترافية متجاوبة مع جميع الأجهزة
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-gray-800 mb-6">
                <span className="text-blue-600">مميزات</span> خدمتنا
              </h2>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-blue-100 text-xl max-w-3xl mx-auto">
                خدمات متقدمة لتطوير موقعك الإلكتروني وتحسين أدائه
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">
                ماذا يقول <span className="text-blue-600">عملاؤنا</span>؟
              </h2>
            </div>
      ...
      <div className="bg-gray-900 py-20">
        <div className="container mx-auto px-6" dir="rtl">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-8">جاهز لبدء مشروعك؟</h2>
